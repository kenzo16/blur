function [k]=deconv_freq_filt_gauss(y,k_sz1,k_sz2,sig_noise,bmp_outname,dispOn,edges_w)
%function [k,ex,ssde]=deconv_freq_filt_gauss(y,k_sz1,k_sz2,x,sig_noise,bmp_outname,dispOn,edges_w)
%blind deconvolution on an image, assuming a Gaussian prior on the
%derivatives
%This function solves in the derivatives space, that is, solve for each
%derivative independently, without enforcing integrability.  
